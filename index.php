	...
	<div class="employees">
		<div class="container">
			...
			<div class="employees__container">
				<div class="employees__icon"><i class="ion-chevron-left"></i></div>
				<div class="employees__list">
					<div class="employee">
						<div class="employee__photo" style="background-image:url(http://placekitten.com/640/480)"></div>
						<p class="employee__name">Сотрудник 1</p>
						<p class="employee__position">web-разработчик</p>
					</div>
					<div class="employee">
						<div class="employee__photo" style="background-image:url(http://placekitten.com/640/480)"></div>
						<p class="employee__name">Сотрудник 2</p>
						<p class="employee__position">web-разработчик</p>
					</div>
					<div class="employee">
						<div class="employee__photo" style="background-image:url(http://placekitten.com/640/480)"></div>
						<p class="employee__name">Сотрудник 3</p>
						<p class="employee__position">web-разработчик</p>
					</div>
					<div class="employee">
						<div class="employee__photo" style="background-image:url(http://placekitten.com/640/480)"></div>
						<p class="employee__name">Сотрудник 4</p>
						<p class="employee__position">web-разработчик</p>
					</div>
				</div>
				<div class="employees__icon"><i class="ion-chevron-right"></i></div>
			</div>
		</div>   
	</div>
	<div class="footer">
		<div class="container">
			<div class="copyright">© 2017 E-Create</div>
		</div>
	</div>
